...
# Reference: https://github.com/confluentinc/confluent-kafka-python/blob/master/examples/json_producer.py
#
...
def main(args):
  ...
  json_serializer = JSONSerializer(
      schema_str, schema_registry_client, user_to_dict)
...
if __name__ == '__main__':
  parser = argparse.ArgumentParser(
      description="JSONSerializingProducer Example")
